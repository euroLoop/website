...
function initialize() { // All the setup for the maps, polyines etc. Also the listeners.
    ...
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: 10,
        center: new google.maps.LatLng(46.35, 7),
        mapTypeId: 'terrain'
    });

    var CnrInitPts = [ // starting polyline. needs to be set by city selection in the UI.
        new google.maps.LatLng(46.38, 6.24), //Nyon
        new google.maps.LatLng(46.37, 6.48), //Thonon
        new google.maps.LatLng(46.52, 6.63) //Lausanne
        //new google.maps.LatLng(46.52, 6.63)
    ];
